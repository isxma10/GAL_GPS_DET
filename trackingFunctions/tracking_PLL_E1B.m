function [trackResults, channel]= tracking_PLL_E1B(fid, channel, settings)
...
codePeriods = settings.msToProcess/4;     % For Galielo one spreading code is 4 ms
...
for channelNr = 1:settings.numberOfChannels
    ...
    if (channel(channelNr).PRN ~= 0)
        ...
        E1BCode = generateE1Bcode(channel(channelNr).PRN,1);
        % Then make it possible to do early and late versions
        E1BCode = [E1BCode(8183) E1BCode(8184) E1BCode E1BCode(1) E1BCode(2)];
